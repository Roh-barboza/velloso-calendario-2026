...
// URLs das planilhas — espelhadas aqui para o proxy de dev
...
export default defineConfig({
  ...
  server: {
    ...
    // Proxy para /api/sheets-proxy em dev (evita CORS)
    proxy: {
      '/api/sheets-proxy': {
        ...
        rewrite: (p) => {
          ...
          const sheet = url.searchParams.get('sheet') ?? 'vendas';
          const upstream = SHEET_URLS[sheet] ?? SHEET_URLS.vendas;
          // Retorna só o path + query do upstream
